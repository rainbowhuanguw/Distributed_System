...
public class MyThread extends Thread {
  //private static final String PREFIX = "http://34.201.110.30:8080/A1_war/skiers/"
  private static final String PREFIX = "http://localhost:8080/A1_war_exploded/skiers/"
  ...
  private final ConcurrentLinkedQueue<InfoPackage> queue;
  ...
  public void sendPostRequest(int skierId, int timeValue, int liftId) {
    ...
    // add to queue
    queue.add(new InfoPackage(startTime, endTime, POST, response.statusCode()));
  }
}
